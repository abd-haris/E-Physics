...
var O = (e, a, n) => a.has(e) || X('Cannot ' + n);
var l = (e, a, n) => (O(e, a, 'read from private field'), n ? n.call(e) : a.get(e)),
  u = (e, a, n) =>
    a.has(e)
      ...
      : a instanceof WeakSet
        ? a.add(e)
        : a.set(e, n),
  o = (e, a, n, t) => (O(e, a, 'write to private field'), t ? t.call(e, n) : a.set(e, n), n),
  G = (e, a, n) => (O(e, a, 'access private method'), n);
(function () {
  ...
  new MutationObserver((i) => {
    for (const s of i)
      if (s.type === 'childList')
        for (const d of s.addedNodes) d.tagName === 'LINK' && d.rel === 'modulepreload' && t(d);
...
function J(e) {
  const a = e.split('/').filter((t) => t),
    n = {};
  if ((a.length > 0 ? (n.resource = a[0]) : (n.resource = null), a.length > 1)) {
    const t = a[1],
      i = a[2];
    (a[3],
      n.resource === 'my-class' && t === 'my'
        ? (n.isMyPage = !0)
        : t === 'course' && a.length > 2
          ? ((n.courseSegment = t), (n.moduleId = a[2]))
          : a.length > 2 && i === 'corridor'
            ? ((n.id = t), (n.corridor = i))
            : i === 'module' && a.length > 3
              ? ((n.id = t), (n.module = i), (n.moduleId = a[3]))
              : (n.id = t));
  }
  return n;
}
function ea(e) {
  let a = '';
  return (
    e.resource && (a = a.concat(`/${e.resource}`)),
    e.resource === 'my-class' && e.isMyPage
      ? `${a}/my`
      : e.resource === 'my-class' && e.courseSegment === 'course' && e.moduleId
        ? `${a}/course/moduleId`
        : e.id && e.corridor
          ? `${a}/:id/corridor`
          : e.id && e.module && e.moduleId
            ? `${a}/:id/module/:moduleId`
            : (e.id && (a = a.concat('/:id')), a || '/')
  );
}
function R() {
...
var g, j;
class sa {
  constructor({ view: a, model: n }) {
    u(this, g);
    u(this, j);
    (o(this, g, a), o(this, j, n));
  }
  async initialDashboard() {
    try {
      const a = await l(this, j).getAllModules();
      if (!a) {
        (console.log('populateDashboard: ', a),
          l(this, g).populateContinueLearningDashboardError());
        return;
      }
      (l(this, g).populateLearningDashboardList(a.data),
        l(this, g).levelLearningDashboard(a.gamification));
    } catch (a) {
      (console.error('initialDashboard: ', a), l(this, g).populateContinueLearningDashboardError());
      return;
    }
  }
}
...
const r = {
    ...
    data: [
      ...
      },
      {
        ...
        joinClass: !1,
        completed: !1,
        image: '/images/image-materi/dinamika-partikel.jpg',
        modules: [
          {
            moduleId: 'module301',
            subTitle: 'Hukum 1 Newton',
            description:
              "Ilmuwan Yunani bernama Aristoteles membagi gerak menjadi 2 yaitu gerak alami dan gerak paksa. Dia menyatakan bahwa gerak alami ialah gerak yang tidak disebabkan oleh gaya. gerak alami di bumi contohnya gerak ke atas atau ke bawah. Sedangkan gerak paksa ialah gerak yang disebabkan oleh gaya. Contohnya adalah tarikan dan dorongan. Jika pada suatu benda yang bergerak tidak bekerja gaya luar, suatu saat benda itu akan kembali ke keadaan alaminya yaitu diam. Dari pernyataan Aristoteles tersebut memunculkan sebuah pertanyaan, benarkah bahwa suatu benda tidak mungkin mempertahankan geraknya? Galileo ialah orang yang pertama kali mengemukakan jawaban untuk pertanyaan diatas. Melalui percobaan menjatuhkan bola pada permukaan lengkung yang licin, Galileo menyatakan bahwa jika gesekan angin dan gesekan antarpermukaan dapat ditiadakan, kelajuan konstan benda pada lintasan lurus dapat terus dipertahankan tanpa memerlukan gaya dari luar. Jawaban Galileo ini memginspirasi Isaac Newton untuk menyatakan hukum pertamanya yang berbunyi: 'Jika resultan gaya pada suatu benda sama dengan nol, benda yang mula-mula diam akan tetap diam dan benda yang mula-mula bergerak akan terus bergerak dengan kecepatan konstan.' Berdasarkan hukum pertama ini, Newton menyimpulkan bahwa benda memiliki kecenderungan untuk mempertahankan geraknya (Inersia).",
            completed: !1,
            completedAt: null,
          },
          {
            moduleId: 'module302',
            subTitle: 'Hukum 2 Newton',
            description:
              'Hukum I Newton berkaitan dengan gerak suatu benda ketika resultan gaya yang bekerja pada benda sama dengan nol (F = 0 Pada keadaan seperti ini, kecepatan benda adalah tetap atau benda mengalami gerak lurus beraturan. Kita katakan bahwa benda tidak mengalami percepatan atau percepatannya nol. Bagaimana jika pada benda bekerja sebuah gaya saja atau beberapa gaya yang resultannya tidak nol? Pada keadaan ini ternyata kecepatan benda selalu berubah. Kita katakan bahwa benda mengalami percepatan. Jelas bahwa ada kaitan antara resultan gan dengan percepatan yang ditimbulkannya. Kaitan antara percepatan dan tesultannya inilah yang diselidiki oleh Newton, sehingga a berhasil menceruskan hukum keduanya tentang gerak, yang dikenal sebagai hukum II Newton. Hukum II Newton berbunyi: Percepatan yang dihasilkan oleh resultan gaya yang bekerja pada benda berbanding lurus dengan resultan gayanya dan berbanding terbalik dengan massa benda.',
            completed: !1,
            completedAt: null,
          },
          {
            moduleId: 'module303',
            subTitle: 'Hukum 3 Newton',
            description:
              "Newton menyatakan bahwa gaya tunggal yang hanya melibatkan satu benda tak mungkin ada. Gaya hanya hadir jika sedikitnya ada dua benda yang berinteraksi. Pada interaksi ini gaya-gaya selalu berpasangan. Jika A mengerjakan gaya pada B, maka B akan mengerjakan gaya pada A. Gaya pertama dapat Anda sebut sebagai aksi dan gaya kedua sebagai reaksi. Ini tidak berarti bahwa aksi bekerja lebih dahulu baru timbul reaksi. Kedua gaya ini terjadi bersamaan. Dengan demikian, tidak jadi masalah, gaya mana yang Anda anggap sebagai aksi dan gaya mana yang Anda anggap sebagai reaksi. 'Jika A mengerjakan gaya pada B, maka B akan mengerjakan gaya pada A, yang besarnya sama tetapi arahnya berlawanan'. Hukum ini kadang-kadang dinyatakan sebagai berikut.'Untuk setiap aksi, ada suatu reaksi yang sama besar, tetapi berlawanan arah.'",
            completed: !1,
            completedAt: null,
          },
          {
            moduleId: 'module304',
            subTitle: 'Jenis-Jenis Gaya',
            description:
              "Dalam konsep fisika gaya ialah tarikan atau dorongan yang dialami oleh benda. Ada empat jenis gaya yang bekerja pada suatu benda yaitu (1) gaya berat, (2) gaya normal, (3) gaya gesek, dan (4) gaya tegangan tali. Gaya berat  atau 'berat' ialah gaya gravitasi bumi yang bekerja pada benda. Berat disini berbeda definisinya dengan massa. 'Massa' ialah ukuran kelembaman atau inersia yang dimiliki oleh benda. Namun keduanya saling berhubungan. Semakin besar massa yang dimiliki benda semakin berat pula benda tersebut. Gaya normal didefinisikan sebagai gaya yang bekerja pada bidang sentuh antara 2 permukaan yang bersentuhan, yang arahnya selalu tegak lurus terhadap bidang sentuh. Sedangkan gaya gesek, ia mirip dengan gaya normal yaitu sama-sama bekerja pada bidang sentuh antara 2 benda. Perbedaannya, arah gaya gesek searah dengan permukaan bidang sentuh dan berlawanan dengan kecenderungan arah gerak benda. Terakhir ialah gaya tegangan tali. Gaya ini bekerja pada ujung-ujung tali karena tali tersebut tegang.",
          },
        ],
        progress: 0,
      },
      {
        ...
        joinClass: !1,
        completed: !1,
        image: '/images/image-materi/fluida-statis.jpg',
        modules: [
          {
            moduleId: 'module401',
            subTitle: 'Tekanan',
            description:
              'Tekanan didefinisikan sebagai gaya normal yang bekerja pada suatu bidang dibagi  dengan luas permukaan bidang tersebut. Tekanan yang dialami benda ketika di udara dan di air itu berbeda. Tekanan yang dialami oleh benda yang berada di medium udara dinamakan tekanan udara atau tekanan atmosfer. Jika suatu benda berada dalam wadah yang berisi zat cair, tekanan yang dialami oleh benda tersebut dipengaruhi oleh massa jenis zat cair, kedalaman benda, dan gaya gravitasi. Tekanan yang dialami benda ketika berada dalam zat cair dinamakan tekanan hidrostatis.',
            completed: !1,
            completedAt: null,
          },
          {
            moduleId: 'module402',
            subTitle: 'Hukum Pascal',
            description:
              "Ketika anda memeras ujung kantong plastik berisi air yang memiliki banyak lubang, air akan memancar  dari setiap lubang dengan sama kuat. Hasil percobaan ini diamati oleh 'Blaise Pascal' yang kemudian menyimpulkannya dalam hukum pascal yang berbunyi: 'Tekanan yang diberikan pada zat cair dalam ruang tertutup diteruskan sama besar ke segala arah'. Contoh penerapan dari hukum pascal ialah dongkrak hidrolik. Dongkrak hidrolik terdiri atas bejana dengan dua kaki yang masing-masing berisi penghisap. Penghisap 1 dan Penghisap 2 masing-masing memiliki ukuran diameter yang berbeda. Selain dongkrak hidrolik, beberapa penerapan dari hukum pascal ialah pompa hidrolik ban sepeda dan mesin hidrolik pengangkat mobil.",
            completed: !1,
            completedAt: null,
          },
          {
            moduleId: 'module403',
            subTitle: 'Hukum Archimedes',
            description:
              "Ketika benda dicelupkan ke dalam zat cair, maka benda akan berada diantara 3 keadaan berikut: (1) mengapung, (2) melayang dan  (3) tenggelam. Keadaan yang dialami oleh benda tersebut dikarenakan adanya gaya apung atau gaya angkat ke atas oleh sebuah fluida. Munculnya gaya apung ialah konsekuensi dari tekanan zat cair yang meningkat seiring bertambahnya kedalaman. Fenomena ini pertama kali diamati oleh Archimedes. Archimedes mengamati bahwa pada bejana yang diisi penuh oleh air,kemudian dimasukkan benda ke dalam air tersebut, maka akan ada sejumlah volume air yang dipindahkan. Ternyata setelah diukur jumlah volume air yang dipindahkan itu sama dengan volume benda yang dicelupkan. Archimedes kemudian menemukan hukumnya yang terkenal yang berbunyi: 'Gaya angkat yang bekerja pada suatu benda yang dicelupkan sebagian atau seluruhnya ke dalam suatu fluida sama dengan berat benda yang dipindahakan ke fluida tersebut.'",
            completed: !1,
            completedAt: null,
          },
          {
            moduleId: 'module404',
            subTitle: 'Tegangan Permukaan',
            description:
      ...
      },
      {
        ...
        joinClass: !1,
        completed: !1,
        image: '/images/image-materi/relativitas.jpg',
        modules: [
          {
            moduleId: 'module601',
            subTitle: 'Relativitas Newton',
            description:
  ...
  W = 'MODULES';
function Y() {
  return typeof Storage > 'u' ? (alert('Browser kamu tidak mendukung local storage'), !1) : !0;
}
function z(e) {
  if (!Y || typeof e != 'object') {
    console.log('local storage tidak tersedia atau data bukan objek: ', e);
    return;
  }
  try {
    localStorage.setItem(W, JSON.stringify(e));
  } catch (a) {
    console.error('gagal menyimpan data ke local storage: ', a);
  }
}
function U() {
  if (Y)
    try {
      ...
      return (
        console.error('Gagal mengambil data dari local storage: ', e),
...
function ra() {
  ...
  for (let t in localStorage)
    localStorage.hasOwnProperty(t) && (e += (t.length + localStorage[t].length) * 2);
  const a = e / 1024,
    n = a / 1024;
  return (
    console.log(`Total ukuran localStorage: ${e} bytes`),
    console.log(`Total ukuran localStorage: ${a.toFixed(2)} KB`),
    console.log(`Total ukuran localStorage: ${n.toFixed(2)} MB`),
    { bytes: e, KB: a, MB: n }
  );
}
const K = {
  async getAllModules() {
    const e = U();
    return (
      console.log('data dari localStorage: ', e),
      e
        ? ((r.data = e.data || r.data),
          (r.gamification = e.gamification || r.gamification),
          console.log('gamification: ', r.gamification))
        : (console.log('Tidak ada data di localStorage, menyimpan data awal:', r), z({ ...r })),
      r.gamification.point >= 100 && r.gamification.point < 150
        ? (r.gamification.level = 2)
        : r.gamification.point >= 150 && r.gamification.point < 250
          ? (r.gamification.level = 3)
          : (r.gamification.level = 1),
      z({ ...r }),
      ra(),
      { ...r }
    );
  },
  async setToMyCourse(e) {
    const a = r.data.findIndex((n) => n.courseId === e);
    return a !== -1
      ? ((r.data[a].joinClass = !0),
        z({ ...r }),
        { status: 'success', message: 'Menambahkan course berhasil', data: r.data[a] })
      : { status: 'error', message: 'course tidak ditemukan' };
  },
  async getMyCourses() {
    const e = U();
    let a = [];
    return (
      e && e.data
        ? (a = e.data.filter((n) => n.joinClass === !0))
        : (a = r.data.filter((n) => n.joinClass === !0)),
      { status: 'success', message: 'Daftar kursus yang digabung', data: a }
    );
  },
  async getDetailMyCourse(e) {
    const a = U();
    a && ((r.data = a.data || r.data), (r.gamification = a.gamification || r.gamification));
    const n = r.data.find((t) => t.courseId === e);
    return n
      ? { status: 'success', message: 'course ditemukan', data: n }
      : { status: 'failed', message: 'course tidak ditemukan' };
  },
  async updateModuleToComplete(e, a) {
    const n = r.data.findIndex((t) => t.courseId === e);
    if (n !== -1) {
      const t = r.data[n].modules.findIndex((i) => i.moduleId === a);
      if (t !== -1) {
        const i = new Date().toISOString();
        r.data[n].modules[t] = { ...r.data[n].modules[t], completed: !0, completedAt: i };
        const s = r.data[n].modules.length,
          d = r.data[n].modules.filter((m) => m.completed).length;
        return (
          (r.data[n].progress = s > 0 ? Math.round((d / s) * 100) : 0),
          r.data[n].progress === 100 && r.data[n].completed !== !0
            ? ((r.gamification.point += 50), (r.data[n].completed = !0))
            : r.data[n].progress === 100 &&
              r.data[n].completed === !0 &&
              (r.gamification.point += 0),
          z({ ...r }),
          {
            status: 'success',
            message: `Modul ${a} ditandai selesai. Progress: ${r.data[n].progress}%`,
          }
        );
      }
    }
...
function V({ courseId: e, image: a, title: n, kelas: t }) {
  return `
        <div class="card bg-base-100 w-full shadow-sm lg:w-72" data-courseId="${e}">
            <figure>
                <img src="/E-Physics/${a}" alt="image-course"/>
            </figure>
...
function ma({ courseId: e, image: a, title: n, kelas: t }) {
  return `
        <div class="card bg-base-100 w-full shadow-sm lg:w-72" data-courseId="${e}">
            <figure>
                <img src="/E-Physics/${a}" alt="image-course" class="vt-item-image"/>
            </figure>
            <div class="card-body flex flex-col gap-y-5">
                <h3 class="card-title text-xl font-bold">${n}</h3>
                <p class="text-base">Kelas ${t}</p>
  ...
  return `
    <div class="w-[80vw] flex flex-col gap-y-5 border border-base-300 rounded-b-2xl box-border">
      <figure class="w-full h-48 overflow-y-hidden bg-center">
        <img src="/E-Physics/${e.image}" alt="course image" class="vt-detail-image">
      </figure>
...
function ka(e, a) {
  const n = la(e, a),
    t = e.modules.find((d) => d.moduleId === a),
    i = t ? t.description : 'Deskripsi tidak tersedia',
    s = e.progress || 0;
  return `
    <div class="flex">
      <div>
  ...
  return `
    <div class="card bg-white w-96 shadow-sm">
      <figure class="px-10 pt-10 flex flex-col">
        <img src="/E-Physics/${e.icon.smart}" alt="Shoes" class="rounded-xl w-28" />
...
function ba(e) {
  return `
    <div class="card bg-warning w-96 shadow-sm">
      <figure class="px-10 pt-10 flex flex-col">
        <img src="/E-Physics/${e.icon.intelligent}" alt="Shoes" class="rounded-xl w-28" />
        <figcaption class="flex flex-col justify-center items-center font-bold">
        <p>Level ${e.level}</p>
...
function ha(e) {
  return `
    <div class="card bg-info w-96 shadow-sm">
      <figure class="px-10 pt-10 flex flex-col">
        <img src="/E-Physics/${e.icon.expert}" alt="Shoes" class="rounded-xl w-28" />
        <figcaption class="flex flex-col justify-center items-center font-bold">
          <p>Level ${e.level}</p>
          <p>${e.badges.expert}</p>
        </figcaption>
...
function ya({ courseId: e, image: a, title: n, kelas: t, progress: i }) {
  return `
...
function va({ courseId: e, image: a, title: n, kelas: t, progress: i }) {
  return `
    <div class="bg-white shadow-sm rounded-xl box-border p-5">
      <figure class="flex gap-x-3 items-center p-3">
        <img src="/E-Physics/${a}" class="w-24 rounded-2xl">
...
class xa {
  ...
  async afterRender() {
    (o(this, I, new sa({ view: this, model: K })), l(this, I).initialDashboard());
    const a = document.querySelector('header');
    a && (a.style.display = 'block');
  }
  populateLearningDashboardList(a) {
    const n = a
        .filter((i) => i.progress > 0 && i.progress < 100)
        .reduce((i, s) => i.concat(ya({ ...s })), ''),
      t = a
        .filter((i) => i.progress === 100)
        .reduce(
          (i, s) => (
            console.log('course module length: ', s.modules.length),
            i.concat(va({ ...s }))
          ),
          '',
        );
    (console.log('continue learning: ', n.length),
      (document.getElementById('continue-learning').innerHTML =
        n.length > 0
          ? `<div class="grid gap-y-3 md:grid-cols-2 md:gap-x-10 md:mx-5 lg:grid-cols-3">${n}</div>`
          : `<div class="md:mx-5">${fa()}</div>`),
      (document.getElementById('finished-learning').innerHTML =
        t.length > 0
          ? `<div class="grid gap-y-3 md:grid-cols-2 md:gap-x-10 md:mx-5 lg:grid-cols-3">${t}</div>`
          : `<div class="md:mx-5">${wa()}</div>`));
  }
  levelLearningDashboard(a) {
    if (a.point >= 0 && a.point < 100)
      return (document.getElementById('card-level').innerHTML = pa(a));
    if (a.point >= 100 && a.point < 200)
      return (document.getElementById('card-level').innerHTML = ba(a));
    if (a.point >= 200 && a.point < 350)
      return (document.getElementById('card-level').innerHTML = ha(a));
  }
}
I = new WeakMap();
var M, y;
class ja {
  constructor({ view: a, model: n }) {
    u(this, M);
    u(this, y);
    (o(this, M, a), o(this, y, n));
  }
  async initialListModule() {
    const a = await l(this, y).getAllModules();
    if (!a) {
      console.log('response tidak ditemukan!');
      return;
    }
    l(this, M).populateListModules(a.message, a.data);
  }
  async setMyCourse(a) {
    (await l(this, y).setToMyCourse(a), a || console.log('courseId tidak ditemukan'));
  }
}
...
class Ia {
  ...
  async afterRender() {
    (o(this, c, new ja({ view: this, model: K })), await l(this, c).initialListModule());
    const a = document.querySelector('header');
    a && (a.style.display = 'block');
  }
  populateListModules(a, n) {
    const t = n.reduce((d, m) => d.concat(V({ ...m })), '');
    document.getElementById('class-list__item').innerHTML = t;
    const i = document.getElementById('select'),
      s = document.getElementById('class-list__item');
    (i.addEventListener('change', () => {
      const d = i.value;
      this.getCoursesByClass(d, n, s);
    }),
      n.map((d) => {
        document.querySelector(`#btn-kelas-${d.courseId}`).addEventListener('click', () => {
          (console.log('courseId: ', d),
            l(this, c).setMyCourse(d.courseId),
            l(this, c).initialListModule());
        });
      }),
      document.getElementById('search-course').addEventListener('submit', (d) => {
        let m = document.getElementById('search-title').value.toLowerCase();
        (console.log('searchInput: ', m),
          d.preventDefault(),
          this.searchCourse(m, n, s),
          d.target.reset());
      }));
  }
  getCoursesByClass(a, n, t) {
    let i = a ? n.filter((s) => s.kelas === a) : n;
    if ((console.log('filterClass: ', i), i.length > 0)) {
      const s = i.reduce((d, m) => d.concat(V({ ...m })), '');
      t.innerHTML = s;
    }
  }
  searchCourse(a, n, t) {
    console.log('filterCourse: ', typeof n);
    let i = n.filter((s) => s.title.toLowerCase().includes(a));
    if ((console.log('courseTitle: ', i), i.length > 0)) {
      const s = i.reduce((d, m) => d.concat(V({ ...m })), '');
      t.innerHTML = s;
    }
  }
...
class Ma {
  constructor({ view: a, model: n }) {
    u(this, L);
    u(this, T);
    (o(this, L, a), o(this, T, n));
  }
  async initialMyListModule() {
    const a = await l(this, T).getMyCourses();
    if (!a) {
      console.log('response tidak ditemukan!');
      return;
    }
    l(this, L).populateMyListModules(a.message, a.data);
  }
}
((L = new WeakMap()), (T = new WeakMap()));
function La(e, a, n, t) {
  if (((e.value = n), n <= 0)) {
    ((a.textContent = '0%'), (t.textContent = 'Mulai belajar'));
    return;
  }
  ((a.textContent = `${e.value}%`),
    n > 0 && (t.textContent = 'Lanjut belajar'),
    n === e.max && (t.textContent = 'Course selesai'));
}
function Ta(e, a) {
  e.addEventListener('click', () => {
    a.classList.toggle('-translate-x-[100%]');
  });
}
function $a(e, a, n, t) {
  e.addEventListener('click', () => {
    (a.classList.remove('lg:translate-x-0'),
      a.classList.add('lg:-translate-x-[100%]'),
      t.classList.remove('justify-end'),
      t.classList.add('justify-center'),
      setTimeout(() => {
        (n.classList.remove('translate-x-[-100%]', 'opacity-0', 'hidden'),
          n.classList.add('translate-x-0', 'opacity-100', 'lg:block'));
      }, 300));
  });
}
function Ca(e, a, n) {
  e.addEventListener('click', () => {
    (e.classList.add('translate-x-[-100%]', 'opacity-0'),
      setTimeout(() => {
        (a.classList.add('lg:translate-x-0'),
          a.classList.remove('lg:-translate-x-[100%]'),
          n.classList.remove('justify-center'),
          n.classList.add('justify-end'),
          e.classList.add('hidden'));
      }, 300));
  });
}
function Sa(e, a, n) {
  ((e.value = n), (a.textContent = `${n}%`));
}
function Pa({ skipTransition: e = !1, updateDOM: a }) {
  if (e || !document.startViewTransition) {
    const n = Promise.resolve().then(a);
    return {
      ready: Promise.reject(Error('View transition unsupported')),
      updateCallbackDone: n,
      finished: n,
    };
  }
  return document.startViewTransition(a);
}
var $;
class Da {
  constructor() {
  ...
  async afterRender() {
    (o(this, $, new Ma({ view: this, model: K })), l(this, $).initialMyListModule());
    const a = document.querySelector('header');
    a && (a.style.display = 'block');
  }
  populateMyListModules(a, n) {
    if (n.length <= 0) {
      this.populateMyClassEmpty();
      return;
    }
    const t = n.reduce((i, s) => i.concat(ma({ ...s })), '');
    ...
    `),
      n.map((i) => {
        La(
          document.querySelector(`#progress-${i.courseId}`),
          document.querySelector(`#percentage-${i.courseId}`),
          i.progress,
          document.querySelector(`[data-courseId="${i.courseId}"] .card-btn`),
        );
      }));
  }
  populateMyClassEmpty() {
    document.getElementById('my-class-list__item').innerHTML = ga();
  }
}
$ = new WeakMap();
var C, k, S;
class Ba {
  constructor(a, { view: n, model: t }) {
    u(this, C);
    u(this, k);
    u(this, S);
    (o(this, C, a), o(this, k, n), o(this, S, t));
  }
  async initialDetailMyModule() {
    try {
      const a = await l(this, S).getDetailMyCourse(l(this, C));
      if (!a) {
        l(this, k).showError('Data kursus tidak ditemukan.');
        return;
      }
      l(this, k).populateMyDetailModule(a.message, a.data);
    } catch (a) {
      l(this, k).showError('Terjadi kesalahan saat memuat data kursus: ' + a.message);
    }
  }
}
((C = new WeakMap()), (k = new WeakMap()), (S = new WeakMap()));
var P;
class Ea {
  constructor() {
    u(this, P);
  ...
  async afterRender() {
    (o(this, P, new Ba(_().id, { view: this, model: K })),
      await l(this, P).initialDetailMyModule());
    const a = document.querySelector('header');
    a && (a.style.display = 'block');
    const n = document.querySelector('footer');
    n && (n.style.display = 'block');
  }
  populateMyDetailModule(a, n) {
    document.getElementById('detail-class').innerHTML = ca(n);
    const t = document.getElementById('btn-learn');
    return n.progress === 0
      ? (t.textContent = 'Mulai belajar')
      : n.progress > 0 && n.progress < 100
        ? (t.textContent = 'Lanjut belajar')
        : (t.textContent = 'Belajar lagi');
  }
  showError(a) {
...
class Aa {
  constructor(a, { view: n, model: t }) {
    ...
    u(this, B);
    u(this, p);
    (o(this, D, a), o(this, B, n), o(this, p, t));
  }
  async initialDetailModule() {
    try {
      const a = await l(this, p).getDetailMyCourse(l(this, D));
      if ((console.log('response : ', a), !a)) {
        console.log('response tidak ditemukan');
        return;
      }
      l(this, B).populateDetailModule(a.message, a.data);
    } catch (a) {
      console.error('initialDetailModule: ', a.message);
    }
  }
  async completedModule(a, n) {
    try {
      (l(this, p).updateModuleToComplete(a, n),
        console.log('updateModuleToComplete: ', l(this, p).updateModuleToComplete(a, n)));
    } catch (t) {
      console.error('completedModule: ', t);
    }
  }
}
((D = new WeakMap()), (B = new WeakMap()), (p = new WeakMap()));
var f, v, E;
class Ha {
  constructor() {
    u(this, f);
  ...
  async afterRender() {
    ...
    (o(this, E, a.id),
      o(this, v, a.moduleId),
      o(this, f, new Aa(a.id, { view: this, model: K })),
      l(this, f).initialDetailModule());
    const n = document.querySelector('header');
    n && (n.style.display = 'none');
    const t = document.querySelector('footer');
    t && (t.style.display = 'none');
  }
  populateDetailModule(a, n) {
    ((document.getElementById('detail-module').innerHTML = ka(n, l(this, v))),
      Ta(document.getElementById('drawer-sidebar'), document.getElementById('default-sidebar')),
      $a(
      ...
      document.getElementById('module-completed').addEventListener('click', () => {
        (l(this, f).completedModule(l(this, E), l(this, v)),
          Sa(
...
((f = new WeakMap()), (v = new WeakMap()), (E = new WeakMap()));
const aa = {
  '/': () => new xa(),
  '/list-class': () => new Ia(),
  '/my-class/my': () => new Da(),
  '/my-class/:id/corridor': () => new Ea(),
  '/my-class/:id/module/:moduleId': () => new Ha(),
};
var w, A, H, N, b, h, Q, na;
class Na {
  constructor({ content: a, headerList: n, navigationDrawer: t, headerPoint: i }) {
    u(this, h);
    u(this, w);
    u(this, A);
    u(this, H);
    u(this, N);
    u(this, b);
    (o(this, w, a), o(this, A, n), o(this, H, t), o(this, N, i), o(this, b, R()));
  }
  async renderPage() {
    const a = Z(),
      n = _(),
      t = aa[a] || aa['/'];
    let i = a;
    a.startsWith('my-class') ? (i = 'my-class') : a === '/' && (i = 'dashboard');
    const s = t();
    if ((s.setParams && (s.setParams = n), !document.startViewTransition)) {
      ((l(this, w).innerHTML = await s.render()),
        await s.afterRender(),
        G(this, h, Q).call(this, i));
      return;
    }
    const d = G(this, h, na).call(this);
    let m = null,
      x = null;
    if (d === 'list-to-detail' && t) {
      const F = _();
      ((m = document.querySelector(`
        .card[data-courseId="${F.id}"] .vt-item-image
        `)),
        m && (m.style.viewTransitionName = 'detail-image'));
    }
    d === 'detail-to-list' &&
      t &&
      ((x = document.querySelector('.vt-detail-image')),
      x && (x.style.viewTransitionName = 'detail-image'));
    const q = Pa({
      updateDOM: async () => {
        if (
          ((l(this, w).innerHTML = await s.render()),
    ...
    (q.ready.catch(console.error),
      q.updateCallbackDone
        .then(() => {
          (scrollTo({ top: 0, behavior: 'instant' }), G(this, h, Q).call(this, i));
        })
        .catch(console.error),
      q.finished.then(() => {
        (m && (m.style.viewTransitionName = ''),
          x && (x.style.viewTransitionName = ''),
          o(this, b, R()));
      }));
  }
}
((w = new WeakMap()),
  ...
  (Q = function (a) {
    const n = l(this, A),
      t = l(this, H).children.namedItem('drawer'),
      i = l(this, N);
    ((n.innerHTML = ua(a)), (t.innerHTML = da(a)), (i.innerHTML = oa()));
  }),
  (na = function () {
    const a = ta(l(this, b)),
      n = Z(),
      t = ['/my-class/my'],
      i = ['/my-class/:id/corridor'];
    return t.includes(a) && i.includes(n)
      ? 'list-to-detail'
      : i.includes(a) && t.includes(n)
        ? 'detail-to-list'
        : null;
  }));
